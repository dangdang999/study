!function(window) {
    ...
    util.editor = function(e, t, o) {
        ...
        var r = function(a, r) {
            ...
            a.registerUI("myinsertvideo", function(e, i) {
                e.registerCommand(i, {
                    execCommand: function() {
                        r.show(function(t) {
                            if (t) {
            ...
            a.registerUI("myinsertvoice", function(e, i) {
                e.registerCommand(i, {
                    execCommand: function() {
                        r.show(function(t) {
    ...
    util.loading = function(e) {
        ...
        t = $("#modal-loading"),
        html = '<div class="modal-dialog">\t<div style="text-align:center; background-color: transparent;">\t\t<img style="width:48px; height:48px; margin-top:100px;" src="../attachment/images/global/loading.gif" title="正在努力加载...">\t\t<div>' + e + "</div>\t</div></div>",
        t.html(html),
        t.modal("show"),
    ...
    util.dialog = function(e, t, i, o) {
        ...
        if (0 == n.length && ($(document.body).append('<div id="' + o.containerName + '" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"></div>'),
        n = $("#" + o.containerName)),
        html = '<div class="modal-dialog we7-modal-dialog">\t<div class="modal-content">',
        e && (html += '<div class="modal-header">\t<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>\t<h3>' + e + "</h3></div>"),
        t && ($.isArray(t) ? html += '<div class="modal-body">正在加载中</div>' : html += '<div class="modal-body">' + t + "</div>"),
        i && (html += '<div class="modal-footer">' + i + "</div>"),
        html += "\t</div></div>",
        n.html(html),
        t && $.isArray(t)) {
            var a = function(e) {
    ...
    util.message = function(e, t, i) {
        ...
        if (t && t.length > 0) {
            if ("success" == i) {
                ...
                "back" == t ? window.history.back(-1) : "refresh" == t ? (t = location.href,
            ...
            var a = '\t\t\t<button type="button" class="btn btn-primary" data-dismiss="modal">确认</button>';
    ...
    util.modal_message = function(e, t, i, o, n, a) {
        ...
        if (!i || getQuery(i) == getQuery(window.location.href)) {
            ...
            "" == o && (o = "success"),
            -1 != $.inArray(o, ["success"]) && (s = !0,
            n = n || 3);
            var c = '\t\t\t<div class="text-center">\t\t\t\t\t<i class="text-' + o + " wi wi-" + l[o] + '"></i>' + t + '\t\t\t</div>\t\t\t<div class="clearfix"></div>';
            if (!s && (i = i || "./?refresh",
            e = e || "系统提示",
            d = '\t\t<a href="' + i + '" class="btn btn-primary">确认</a>',
            "" != a && a.length > 0))
                for (var u = 0; u < a.length; u++)
                    d = d + '<a href="' + a[u].url + '" class="btn btn-primary">' + decodeURIComponent(a[u].title) + "</a>";
